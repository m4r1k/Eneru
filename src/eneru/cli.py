...
def main():
    ...
    # The locator args live on the parent too so `eneru user --auth-db …` works
    # with no subcommand. Subcommands re-declare them so they can also follow the
    # subcommand (`eneru user list --auth-db …`).
