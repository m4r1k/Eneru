...
- `tests/test_dashboard_outlook.py` covers the role-aware banner and tab
  ...
  remote checks, CSP-safe/newest-first/pulse-only-when-blinking guards, and
  the amber `arming` FAILSAFE countdown (next-trigger line, banner rank).
